                ...
                imageClick: function (context, img) {
                    ...
                    var iframeMouseMove = function (e) {
                        if (imageResizeinProgress) {
                            ...
                            if(settings.keepAspectRatio || e.shiftKey){
