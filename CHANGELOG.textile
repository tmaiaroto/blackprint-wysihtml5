*blackprint-wysihtml5 0.5.0* (Nov 6, 2013)

* Support for "style" attribute
* Resizeable images (style attribute gets set with width and height)
* Twitter Bootstrap & Font Awesome styled toolbar
